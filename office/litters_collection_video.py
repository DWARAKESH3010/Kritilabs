...
# === CONFIG ===
background_image_path = r"D:\coding\office\input\first_image.png"
video_path = r"D:\coding\office\input\sample_video.mp4"
output_video_path = r"D:\coding\office\input\output_result.avi"
resize_dim = (1280, 720)
min_persistence_frames = 80  # For ~5 seconds if 30 FPS
...
while True:
    ...
    _, mask = cv2.threshold(diff, 58, 255, cv2.THRESH_BINARY)
    ...
    # Add label if litter is detected
    if persistent_detected:
        label_text = "Littering Detected"
        ...
        # Put white text
        cv2.putText(frame, label_text, (15, 10 + text_h), font, font_scale, (255, 255, 255), font_thickness)
